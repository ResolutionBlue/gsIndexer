...
json_file = '''
{
    ...
    "ru": {
        ...
        "no folders in workshopcontent": "    Внутри 'WorkshopContent' не обнаружено ни одной папки c модами.",
        "please choose an option": "Пожалуйста, выберите вариант:",
        "automatic option": "1. Автоматическое определение пути к папке c модами",
        "manual option": "2. Введите путь к папке вручную",
        "kb": "КБ",
        "please confirm this action": "Пожалуйста, подтвердите это действие.",
        "mod folder": "Имя папки c модами:",
        ...
        "enter folder path": "Введите путь к папке c модом:",
